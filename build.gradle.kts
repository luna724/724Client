...
group = "luna724.iloveichika.lunadayo"
archivesName = "724client"
version = "7.2.4"
...
loom {
    ...
    forge {
        ...
        mixinConfig("mixins.724client.json")
    }
    mixin {
        defaultRefmapName.set("mixins.724client.refmap.json")
    }
}
...
tasks.withType(Jar::class) {
    archiveBaseName.set("724client")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    manifest.attributes.run {
        this["FMLCorePluginContainsFMLMod"] = "true"
        this["ForceLoadAsMod"] = "true"

        this["MixinConfigs"] = "mixins.724client.json"
